...
module.exports = async (client) => {
    ...
    commandFiles.map((value) => {
        ...
        if (!file.description)
            return Table_command.addRow(file.name,`ERROR IN DESCRIPTION(DESCRIPTION)`)
    ...
    slashCommands.map((value) => {
        ...
        if (!file.description)
            return Table_slash.addRow(file.name,`ERROR IN DESCRIPTION(DESCRIPTION)`)
